...
export function renderSvg(events, options = {}) {
  ...
  edges.forEach((edge) => {
    ...
    const base = `<line data-edge-id="${edge.id}" class="${classes}"${removedAttr} x1="${x1}" y1="${y1}" x2="${x2}" y2="${y2}" stroke="#2c1f16" stroke-width="1" />`;
    ...
    shapes.push(
      `<line data-edge-id="${edge.id}" class="${classes}"${removedAttr} x1="${x1}" y1="${y1}" x2="${x2}" y2="${y2}" stroke="#2c1f16" stroke-width="1">` +
  ...
  nodes.forEach((node) => {
    ...
    const base = `<rect data-node-id="${node.id}" class="${classes}" x="${node.x - 4}" y="${node.y - 4}" width="8" height="8" fill="#2c1f16" />`;
    ...
    shapes.push(
      `<rect data-node-id="${node.id}" class="${classes}" x="${node.x - 4}" y="${node.y - 4}" width="8" height="8" fill="#2c1f16">` +
